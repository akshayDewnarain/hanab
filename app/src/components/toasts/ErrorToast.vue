<template>
    <div class="p-4">
        <div class="pointer-events-auto w-full max-w-sm shadow-md">
            <div
                class="flex items-start gap-3 rounded border border-red-200 bg-gradient-to-r from-[#ffe2e2]/90 to-[#ffffff]/90 p-4 shadow-lg shadow-red-100/50 backdrop-blur"
            >
                <!-- Icon bubble -->
                <div class="mt-0.5 flex h-9 w-9 items-center justify-center rounded-full">
                    <Icon
                        class="w-6 h-6 max-h-[20px] max-w-[20px] bg-red-500 rounded-full"
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="mt-0.5 text-sm text-slate-500">{{ toastBody }}</p>
                </div>
            </div>
        </div>
    </div>
