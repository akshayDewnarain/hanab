                ...
                <div class="flex items-center gap-3">
                    <div class="flex flex-col">
                        <div class="flex items-center gap-2">
                            <Icon class="w-4 h-4 text-[var(--color-primary)]" icon="material-symbols:local-bar-rounded" />
                            <span class="font-semibold truncate">{{ t(label) }}</span>
                        </div>
                        <span class="text-xs font-medium text-gray-500">Add or remove drinks for this order.</span>
                    </div>
...
<script lang="ts" setup>
    ...
    /** Drink (or similar) rows from the API; map stores loose records. */
